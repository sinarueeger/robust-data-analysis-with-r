...
For the workshop are going to use [RStudio Cloud](https://rstudio.cloud/spaces/24655/join?access_code=nN9TW6co5lZRS5yKGO4Xp1ZChDUXoyCGVzamIzXQ). 
...
<div class="figure">
<img src="img/import-data.png" height="500" alt="Import data" />
</div>
