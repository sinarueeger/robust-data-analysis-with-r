...
.pull-left[
# **1.**
### [What makes a Data Analysis robust?](#data-analysis)

<br>

# **3.** 
### [Workshop: Can we use R?](#workshop) 

]

.pull-right[
# **2.** 
### [How can R help with that?](#r)

<br>

# **4.** 
### [How can we learn R?](#learning-r)
]
...
| *Functions*  |  *Purpose* |
|---|---|
| 1. `read_excel()`   | A. sdfsdf |
| 2. `read_delim()` | B. sdfsfd  |
| 3. `clean_names()` |  C. |
| 4. `read_csv()`  |  D.  |
| 5. `write_delim()`  |  E. |
