...
<div class="figure">
<img src="img/dailyworkflow/dailyworkflow.001.jpeg" width="300" alt="R 4 DS image" />
</div>
...
C+P r bit into one of the following streams:
...
Start with gist.github.com, then move to blogdown + submit to https://rweekly.org/.
